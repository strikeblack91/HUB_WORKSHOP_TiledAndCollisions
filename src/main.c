...
#define MAP_PATH "assets/tuto.png" // HERE replace the actual PATH by your new map PATH
#define C_PATH "assets/character.png" // HERE replace the actual PATH by your new character PATH
